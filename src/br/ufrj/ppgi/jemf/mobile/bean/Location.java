...
public class Location extends AbstractLocation implements Parcelable, Comparable<Location> {
	 ...
	 */
	public Location(String status, String timeStamp, int interval) {
		super();
	...
	/**
	 * Location Parcelable Constructor.
	...
	/**
	 * Write Location data to Parcelable. 
	 */
	@Override
	...
	/**
	 * Public Location Parcelable Constructor.
	 */
	public static final Parcelable.Creator<Location> CREATOR = new Parcelable.Creator<Location>() {
		/**
		 * Create a Location from Parcel.
		 * @return Location
		 */
		@Override
