...
import br.ufrj.ppgi.jemf.core.coordination.AbstractResponder;
 ...
 *
 */
public class Responder extends AbstractResponder implements Parcelable, Comparable<Responder> {
	 ...
	 */
	public Responder(String name, int gender, String birthDate, int age, String login, String password) {
		super();
		this.setName(name);
	...
	/**
	 * Responder Parcelable Constructor.
	...
	/**
	 * Write Responder data to Parcelable. 
	 */
	@Override
	...
	/**
	 * Public Responder Parcelable Constructor.
	 */
	public static final Parcelable.Creator<Responder> CREATOR = new Parcelable.Creator<Responder>() {
		/**
		 * Create a Responder from Parcel.
		 * @return Responder
		 */
		@Override
		public Responder createFromParcel(Parcel source) {
			// Use Parcelable constructor.
			return new Responder(source);
		}

		/**
		 * Create a Responder Array.
		 * @return Array
		 */
		@Override
	...
	/**
	 * Compare Responder objects.
	 * @param another
	 */
	@Override
	public int compareTo(Responder another) {
		return this.getName().compareTo(another.getName());
	}

	/**
	 * Responder Object to String.
	 * @return String
	 */
	@Override
	public String toString() {
		try {
			return new StringBuilder("Responder [")
