 ...
 *
 */
public class TaskLoader extends CustomLoader {

	/**
	 * Constructor.
	 * @param context
	 */
	public TaskLoader(Context context, CustomParams customParams) {
		super(
			context,
			ProviderStatement.TASK.CONTENT_URI_READ,
			ProviderStatement.TASK.PROJECTION_ALL,
			// Selection.
    	...
    	CustomLogger.getInstance().infoLog(TaskLoader.class.getName(), "Class started.");
	}
