 ...
 *
 */
public class LocationLoader extends CustomLoader {

	/**
	 * Constructor.
	 * @param context
	 */
	public LocationLoader(Context context, CustomParams customParams) {
		super(
			context,
			ProviderStatement.LOCATION.CONTENT_URI_READ,
			ProviderStatement.LOCATION.PROJECTION_ALL,
			// Selection.
    	...
    	CustomLogger.getInstance().infoLog(LocationLoader.class.getName(), "Class started.");
	}
