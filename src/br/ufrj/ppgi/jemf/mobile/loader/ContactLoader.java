 ...
 *
 */
public class ContactLoader extends CustomLoader {

	/**
	 * Constructor.
	 * @param context
	 */
	public ContactLoader(Context context, CustomParams customParams) {
		super(
			context,
			ProviderStatement.CONTACT.CONTENT_URI_READ,
			ProviderStatement.CONTACT.PROJECTION_ALL,
			// Selection.
    	...
    	CustomLogger.getInstance().infoLog(ContactLoader.class.getName(), "Class started.");
	}
