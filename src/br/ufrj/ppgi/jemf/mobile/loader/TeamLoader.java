 ...
 *
 */
public class TeamLoader extends CustomLoader {

	/**
	 * Constructor.
	 * @param context
	 */
	public TeamLoader(Context context, CustomParams customParams) {
		super(
			context,
			ProviderStatement.TEAM.CONTENT_URI_READ,
			ProviderStatement.TEAM.PROJECTION_ALL,
			// Selection.
    	...
    	CustomLogger.getInstance().infoLog(TeamLoader.class.getName(), "Class started.");
	}
