 ...
 *
 */
public class PlanLoader extends CustomLoader {

	/**
	 * Constructor.
	 * @param context
	 */
	public PlanLoader(Context context, CustomParams customParams) {
		super(
			context,
			ProviderStatement.PLAN.CONTENT_URI_READ,
			ProviderStatement.PLAN.PROJECTION_ALL,
			// Selection.
    	...
    	CustomLogger.getInstance().infoLog(PlanLoader.class.getName(), "Class started.");
	}
