 ...
 *
 */
public class VictimLoader extends CustomLoader {

	/**
	 * Constructor.
	 * @param context
	 */
	public VictimLoader(Context context, CustomParams customParams) {
		super(
			context,
			ProviderStatement.VICTIM.CONTENT_URI_READ,
			ProviderStatement.VICTIM.PROJECTION_ALL,
			// Selection.
    	...
    	CustomLogger.getInstance().infoLog(VictimLoader.class.getName(), "Class started.");
	}
