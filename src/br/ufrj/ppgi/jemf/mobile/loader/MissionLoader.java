 ...
 *
 */
public class MissionLoader extends CustomLoader {

	/**
	 * Constructor.
	 * @param context
	 */
	public MissionLoader(Context context, CustomParams customParams) {
		super(
			context,
			ProviderStatement.MISSION.CONTENT_URI_READ,
			ProviderStatement.MISSION.PROJECTION_ALL,
			// Selection.
    	...
    	CustomLogger.getInstance().infoLog(MissionLoader.class.getName(), "Class started.");
	}
