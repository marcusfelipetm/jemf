 ...
 *
 */
public class WitnessLoader extends CustomLoader {

	/**
	 * Constructor.
	 * @param context
	 */
	public WitnessLoader(Context context, CustomParams customParams) {
		super(
			context,
			ProviderStatement.WITNESS.CONTENT_URI_READ,
			ProviderStatement.WITNESS.PROJECTION_ALL,
			// Selection.
    	...
    	CustomLogger.getInstance().infoLog(WitnessLoader.class.getName(), "Class started.");
	}
